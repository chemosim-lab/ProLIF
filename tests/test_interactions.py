...
class TestInteractions:
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            ("HBAcceptor.lig_pattern", "c1cc[n+](cc1)[O-]", 1),
            ...
            ("Cationic.lig_pattern", "c1cc[n+](cc1)[O-]", 0),
            ("Cationic.lig_pattern", "C-N=[N+]=[N-]", 0),
            ("Cationic.lig_pattern", "N#[N+]-[N-2]", 0),
            ("Cationic.prot_pattern", "c1cc[n+](cc1)[O-]", 0),
            ("Cationic.prot_pattern", "[*]-[N+](=O)-[O-]", 0),
            ("Cationic.prot_pattern", "C-N=[N+]=[N-]", 0),
            ("Cationic.prot_pattern", "N#[N+]-[N-2]", 0),
            ...
            ("CationPi.cation", "C-N=[N+]=[N-]", 0),
            ("CationPi.cation", "N#[N+]-[N-2]", 0),
            ...
            ("MetalDonor.prot_pattern", "[*]-[N+](=O)-[O-]", 2),
            (
